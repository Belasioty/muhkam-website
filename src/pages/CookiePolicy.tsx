      ...
      <main className="container mx-auto px-4 py-16 pt-24">
        ...
        <div className="prose prose-gray max-w-none">
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground mb-2">Email: info@ghb-emea.com</p>
            <p className="text-muted-foreground mb-2">Phone: +44 7424 5678</p>
            <p className="text-muted-foreground">Address: PO Box 27774, Tornado Tower L22, West Bay Doha, Qatar</p>
          </section>
        </div>
      </main>
