...
const Navbar = () => {
  return (
    <div className="w-full">
      <nav className="h-14 lg:h-16 flex items-center justify-center px-2 md:px-3 lg:px-3">
        <div className="w-full max-w-7xl flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center justify-center flex-1 gap-4 lg:gap-6">
            <button
              onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}
              className="text-[#333] text-sm md:text-sm lg:text-base font-medium cursor-pointer hover:text-[#0A5180] transition-colors"
            >
              Home
            </button>
            <button 
