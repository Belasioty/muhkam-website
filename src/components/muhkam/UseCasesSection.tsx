...
export const UseCasesSection: React.FC = () => {
  return (
    <section id="use-cases" className="bg-background self-center relative flex max-w-full w-full lg:w-[1440px] flex-col overflow-hidden items-center py-8 md:py-16 lg:py-24">
      {/* Background pattern - hidden on mobile and tablet for better readability */}
      <img
        ...
        className="hidden lg:block aspect-[1] object-contain w-[450px] absolute z-0 max-w-full h-[450px] right-10 top-1/2 transform -translate-y-1/2 opacity-50"
        alt="Background pattern"
      />
      
      {/* Simplified background circles - hidden on mobile and tablet */}
      <div className="hidden lg:block absolute z-0 flex w-[930px] max-w-full flex-col -translate-x-2/4 -translate-y-2/4 h-[930px] p-0.5 left-2/4 top-2/4">
        <div className="flex flex-col items-stretch justify-center p-[72px] rounded-[50%] max-md:max-w-full">
          <div className="flex flex-col items-stretch justify-center px-20 py-[86px] rounded-[50%] max-md:max-w-full">
            <div className="flex flex-col items-stretch justify-center px-20 py-[91px] rounded-[50%] max-md:max-w-full">
              <div className="flex flex-col items-stretch justify-center p-[77px] rounded-[50%] max-md:max-w-full">
